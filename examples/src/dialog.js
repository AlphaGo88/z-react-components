    ...
    render() {
        ...
        return (
            <div>
                ...
                <Dialog isOpen={dlg1Open} title='对话框' style={{width: 500}} onRequestClose={this.closeDlg}>
                    啊三季度来看房萨芬的， 啊释放了空间撒反对。阿斯蒂芬撒旦发你离开雷克萨减肥的按说反击率。
                </Dialog>
                <Dialog isOpen={dlg2Open} style={{width: "100%"}} onRequestClose={this.closeDlg1}>
                    啊三季度来看房萨芬的， 啊释放了空间撒反对。阿斯蒂芬撒旦发你离开雷克萨减肥的按说反击率。
                    啊三季度来看房萨芬的， 啊释放了空间撒反对。阿斯蒂芬撒旦发你离开雷克萨减肥的按说反击率。
                    啊三季度来看房萨芬的， 啊释放了空间撒反对。阿斯蒂芬撒旦发你离开雷克萨减肥的按说反击率。
                </Dialog>
                <Dialog title="带表单的对话框" isOpen={dlg3Open} onRequestClose={this.closeDlg2}>
